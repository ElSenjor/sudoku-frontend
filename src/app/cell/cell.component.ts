...
/*   ValueIsZero: boolean = true;
  constructor(){ 
    console.log("current value: " + this.defaultValue)
    this.ValueIsZero = this.ValueEqualToZero(this.defaultValue)
    console.log("Value is Zero? " + this.ValueIsZero)
  } */
